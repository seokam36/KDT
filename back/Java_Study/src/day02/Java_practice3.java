...
public class Java_practice3 {
    public static void main(String[] args) {
        ...
        System.out.println("평균 : " + result/3.0); */
        ...
        System.out.println("원의 넓이 : " + d*d*3.14); */
        ...
        /* System.out.printf("첫 번째 실수 : ");
        double a = sc.nextDouble();
        System.out.printf("두 번째 실수 : ");
        double b = sc.nextDouble();
        System.out.println("비율 : " + (a/b)*100 + "%"); */
