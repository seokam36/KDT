...
public class Java_practice1 {
    public static void main(String[] args) {
        ...
        예시: 제 이름은 홍길동, 나이는 25세, 키는 175.5cm 입니다.*/
        System.out.printf("제 이름은 %s, 나이는 %d세, 키는 %.1fcm 입니다.", name, age2, height);
        System.out.println();
        ...
        */
        ...
        유재석님의 나이는 51세 입니다.
        */
        Scanner sc = new Scanner(System.in, Charset.forName("MS949"));
        System.out.printf("이름을 입력하세요 : ");
        String name1 = sc.next();
        System.out.printf("나이를 입력하세요 : ");
        int age3 = sc.nextInt();
        System.out.println(name1 + "님의 나이는 " + age3 + "세 입니다.");
        ...
        */
        ...
        System.out.println("입력하신 성별은 '" + charAt +"' 입니다.");
        ...
        */
        ...
        System.out.printf("프로그래머입니까 (true/false) : ");
        ...
        System.out.println("프로그래머 여부 : " + bool);
    }
}
