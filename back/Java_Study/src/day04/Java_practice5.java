...
public class Java_practice5 {
    public static void main(String[] args) {
        ...
        System.out.println("1부터 50까지 합계 : " + total); */
        ...
        */
        ...
        while (true) {
            ...
            if (!str.equals("end")) {
                count++;
                System.out.println(count+"회 입력 : " + str);
            } else{
                break;
            }
        }
