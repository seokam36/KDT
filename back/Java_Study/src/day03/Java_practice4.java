...
public class Java_practice4 {
    public static void main(String[] args) {
        ...
        /* System.out.printf("첫 번째 점수 :");
        int a = sc.nextInt();
        System.out.printf("두 번째 점수 :");
        int b = sc.nextInt();
        if(a+b >= 90){
        ...
        /* System.out.printf("주민등록번호(-포함) 13자리를 입력하세요 : ");
        String a = sc.next();
        if(a.charAt(7) == '1'){
        ...
        /* System.out.printf("총 구매 금액 : ");
        int a = sc.nextInt();
        if(a>=50000){
            System.out.println("최종 결제 금액 : " + (int)(a-a*0.1));
        } else if(a>=30000){
            System.out.println("최종 결제 금액 : "+(int)(a-a*0.05));
        } else if(a>=10000){
            System.out.println("최종 결제 금액 : " + (int)(a-a*0.01));
        } else {
            System.out.println("최종 결제 금액 : " + a);
        } */
        ...
        System.out.printf("플레이어1 (0:가위, 1:바위, 2:보) : ");
        int a = sc.nextInt();
