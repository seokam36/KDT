...
public class Java_practice12 {
    public static void main(String[] args) {
        ...
        // Triangle은 Figure 상속 받기때문에 Triangle 인스턴스를 생성할때 부모인 Figure가 생성이 되고 생성되기때문에 Figure타입 변수 사용 가능
        ...
        shape.draw(); // shape 변수는 타입이 Shape이지만 Circle 클래스로 인스턴스 생성했기 때문에 오버라이딩된 원을 그립니다라고 출력한다.
        ...
        Beverage[] beverages = {new Coffee(), new Coke()};
