...
let score2 = Number(prompt("점수 입력"))
if(score+score2 >= 90){
    console.log("성공")
} else {
    console.log("실패")
...
let score2 = Number(prompt("점수 입력"))
if(score > score2){
    console.log(`더 큰수 : ${score}`)
} else {
    console.log(`더 큰수 : ${score2}`)
} */
...
/* let seatList = ['O', 'X', 'O']
let seat = Number(prompt("좌석 번호를 입력(0, 1, 2)"))
if (seatList[seat] == 'O'){
    console.log("예약된 좌석 입니다")
} else {
    console.log("예약되었습니다.")
}
 */
...
/* let score = Number(prompt("점수 입력(0~1000)"))
if(score >= 900){
    console.log("A급 경품")
} else if (score >= 700){
    console.log("B급 경품")
...
/* let role = prompt("역할 입력(admin, editor, viewer)")
if (role == "admin"){
...
let drink = Number(prompt("원하는 음료 (0,1,2)"))
if (drink == 0){
    console.log(`선택하신 음료는 ${drinkNames[0]}입니다. 가격은 ${drinkPrices[0]}원 입니디.`)
} else if (drink == 1) {
    console.log(`선택하신 음료는 ${drinkNames[1]}입니다. 가격은 ${drinkPrices[1]}원 입니디.`)
} else if (drink == 2){
    console.log(`선택하신 음료는 ${drinkNames[2]}입니다. 가격은 ${drinkPrices[2]}원 입니디.`)
} else {
